...
void	ft_start_game(t_map mapInfo)
{
    t_win data;
    t_plr plr;
    t_all all;
    ...
    all.text[1].image = mlx_xpm_file_to_image(all.win->mlx, "./textures/test2.xpm", &all.text[1].img_width, &all.text[1].img_height);
    ...
    all.text[0].image = mlx_xpm_file_to_image(all.win->mlx, "./textures/sprite_1.xpm", &all.text[0].img_width, &all.text[0].img_height);
